    ...
    const emailHtml = `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
        <div style="background:#2C3E2D;color:#fff;padding:20px 24px;border-radius:8px 8px 0 0;">
          <h2 style="margin:0;font-size:18px;">GYC Dealflow — ${typeLabel}</h2>
        </div>
        <div style="padding:24px;background:#f9fafb;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 8px 8px;">
          <table style="width:100%;font-size:13px;margin-bottom:16px;">
            <tr><td style="color:#6b7280;padding:4px 8px;width:100px;">From:</td><td><strong>${userName}</strong> (${userEmail})</td></tr>
            <tr><td style="color:#6b7280;padding:4px 8px;">Type:</td><td>${typeLabel}</td></tr>
            <tr><td style="color:#6b7280;padding:4px 8px;">Page:</td><td>${page}</td></tr>
