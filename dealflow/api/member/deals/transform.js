...
export function transformDeals(parentDeals, childShareClasses, sponsorRows) {
	...
	return (parentDeals || []).map((deal) => {
		...
		const normalizedDeal = {
			...
			fundFoundedYear: deal.fund_founded_year || deal.founded_year || null,
			...
			redemption: deal.redemption || deal.liquidity_terms || deal.liquidityTerms || null,
			...
			currentAvgLoanLtv: deal.current_avg_loan_ltv || deal.avg_loan_ltv || null,
			maxAllowedLtv: deal.max_allowed_ltv || null,
			currentLeverage: deal.current_leverage || null,
			maxAllowedLeverage: deal.max_allowed_leverage || null,
			currentFundSize: deal.current_fund_size || null,
			maxFundSize: deal.max_fund_size || deal.offering_size || null,
			snapshotAsOfDate: deal.snapshot_as_of_date || null,
