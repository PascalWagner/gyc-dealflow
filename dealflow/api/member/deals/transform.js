...
export function transformDeals(parentDeals, childShareClasses, sponsorRows) {
	...
	return (parentDeals || []).map((deal) => {
		...
		const normalizedDeal = {
			...
			totalLoansUnderMgmt: deal.total_loans_under_mgmt || null,
			equityCommitments: deal.equity_commitments || null,
			avgLoanLTC: deal.avg_loan_ltc || null,
			performanceFeePct: deal.performance_fee_pct || null,
			inceptionDate: deal.inception_date || null,
			fundTerm: deal.fund_term || null,
