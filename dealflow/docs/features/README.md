...
| Deal Browser | [deal-browser.md](deal-browser.md) | `/app/deals` | 0 | No tests |
...
| Saved Deals | [saved-deals.md](saved-deals.md) | `/app/saved` | 0 | No tests |
...
| Admin | [admin.md](admin.md) | `/app/admin`, `/app/admin/manage` | 0 | No tests |
| Public Landing | [public-landing.md](public-landing.md) | `/landing` | 0 | No tests |
| Deal Review | [deal-review.md](deal-review.md) | `/deal-review` | 4 smoke, 5 unit | Partial |
