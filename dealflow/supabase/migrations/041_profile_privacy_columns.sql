...
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS share_saved boolean NOT NULL DEFAULT true;
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS share_dd boolean NOT NULL DEFAULT true;
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS share_invested boolean NOT NULL DEFAULT true;
